...
- `shdr_bowtie` — [BowTieVertical.glsl](https://github.com/gl-transitions/gl-transitions/blob/master/transitions/BowTieVertical.glsl) [BowTieHorizontal.glsl](https://github.com/gl-transitions/gl-transitions/blob/master/transitions/BowTieHorizontal.glsl)
...
- `shdr_color_distance` — [ColourDistance.glsl](https://github.com/gl-transitions/gl-transitions/blob/master/transitions/ColourDistance.glsl)
...
- `shdr_multiply_blend` — [multiply_blend.glsl](https://github.com/gl-transitions/gl-transitions/blob/master/transitions/multiply_blend.glsl)
...
- `shdr_rotate_scale_face` — [rotate_scale_fade.glsl](https://github.com/gl-transitions/gl-transitions/blob/master/transitions/rotate_scale_fade.glsl)
